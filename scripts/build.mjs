...
const banner = "/*! @itslil/remark-math 6.0.0 | LilScript reimplementation of remark-math | MIT */\n"
...
await esbuild({
  ...
  bundle: true,
  format: "iife",
  globalName: "remarkMath",
  footer: {
    js: `globalThis.remarkMath=remarkMath.default||remarkMath.remarkMath||remarkMath;`,
  },
  legalComments: "none",
  minifyWhitespace: true,
  minifyIdentifiers: false,
